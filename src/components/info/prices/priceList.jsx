...
//       <h1 className="price-list-title">{t('price list')}</h1>
//       <p className="update-info">{t('price list updated')}: {new Date().toLocaleDateString()}</p>
      
//       <div className="car-options-grid">
//         {cars.map((car) => (
//           <div key={car.id} className="car-option">
//             <h2>{t(car.category)} | {t('{{seats}} seats', { seats: car.seats })} | {car.brand} {car.model}</h2>
